                        ...
                        return `<div class="d-inline-flex">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="javascript:void(0);" data-row='`+ JSON.stringify(row) +`' class="dropdown-item edit-client-link">
                                                <i class="ph-pencil me-2"></i>
                                                Edit
                                            </a>
                                            <a href="javascript:void(0);" data-row='`+ JSON.stringify(row) +`' class="dropdown-item delete-client-link">
